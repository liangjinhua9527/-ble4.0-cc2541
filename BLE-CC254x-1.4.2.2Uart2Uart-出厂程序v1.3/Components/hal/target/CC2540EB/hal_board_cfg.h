...
#define PUSH2_BV                       BV(1)//BV(0)
#define PUSH2_SBIT                     P2_1// P2_0
...
/* LED's */
  ...
  #define HAL_TURN_OFF_LED4()       st( LED4_SBIT = LED4_POLARITY (1); )
  #define HAL_TURN_OFF_LED5()       st( LED5_SBIT = LED5_POLARITY (1); )
  #define HAL_TURN_OFF_LED6()       st( LED6_SBIT = LED6_POLARITY (1); )
...
//  #define HAL_TURN_OFF_LED4()       HAL_TURN_OFF_LED1()
  ...
  #define HAL_TURN_ON_LED4()        st( LED4_SBIT = LED4_POLARITY (0); )
  #define HAL_TURN_ON_LED5()        st( LED5_SBIT = LED5_POLARITY (0); )
  #define HAL_TURN_ON_LED6()        st( LED6_SBIT = LED6_POLARITY (0); )
