...
{
   LCD_Clear();
   HZ_12x12_Display((HZ_12x12+0),3 ,115);
   HZ_12x12_Display((HZ_12x12+1),3 ,103);
   HZ_12x12_Display((HZ_12x12+6),3 ,91);
   HZ_12x12_Display((HZ_12x12+7),3 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,3,73);   
  
   HZ_12x12_Display((HZ_12x12+0),2 ,115);
   HZ_12x12_Display((HZ_12x12+1),2 ,103);
   HZ_12x12_Display((HZ_12x12+4),2 ,91);
   HZ_12x12_Display((HZ_12x12+5),2 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,2,73);  
   
   HZ_12x12_Display((HZ_12x12+0),1 ,115);
   HZ_12x12_Display((HZ_12x12+1),1 ,103);
   HZ_12x12_Display((HZ_12x12+2),1 ,91);
   HZ_12x12_Display((HZ_12x12+3),1 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,1,73); 
   
   HZ_12x12_Display((HZ_12x12+10),3 ,30);
   HZ_12x12_Display((HZ_12x12+11),3 ,18);
   ASCII_6x12_Display(ASCII_6x12+10,3,12); 
}
void ZL_UI_Update()
{
  uint8 i,j;
  ...
  if(Packet_Attribute_1.Heat_Level == Heat_Low)
  {
      HZ_12x12_Display((HZ_12x12+9),3 ,61);
  }
  if(Packet_Attribute_1.Heat_Level == Heat_High)
  {
      HZ_12x12_Display((HZ_12x12+8),3 ,61);
  }
  ...
  if(20<=YB_LOCAL_MSG[2] &&  YB_LOCAL_MSG[2]<= 60) x = YB_LOCAL_MSG[2];
  else                                             x = 20;
  y = x / 10;
  ASCII_6x12_Display(ASCII_6x12+y,2,67);  
  y = x % 10;
  ASCII_6x12_Display(ASCII_6x12+y,2,61);
  ...
  x = Packet_Attribute_1.Cure_Min;
  y = x/10;
  ASCII_6x12_Display(ASCII_6x12+y,1,67); 
  y = x%10%10;
  ASCII_6x12_Display(ASCII_6x12+y,1,61);
  ...
  for(i=0xb4;i<0xb6;i++)
  {
   ...
   x = Packet_Attribute_1.BAT_adc + 1;
   y = x / 10;
   ASCII_6x12_Display(ASCII_6x12+y,3,6);
   y = x % 10;
   ASCII_6x12_Display(ASCII_6x12+y,3,0);
  ...
  if(Packet_Attribute_1.Work_State == Work_Run)
  {
   HZ_16x16_Display(HZ_16x16+0,25);
   HZ_16x16_Display(HZ_16x16+1,4);
  }
  else if(Packet_Attribute_1.Work_State == Work_Stop)
  {
    HZ_16x16_Display(HZ_16x16+2,25);
    HZ_16x16_Display(HZ_16x16+3,4);
  }
  else
  {
    HZ_16x16_Display(HZ_16x16+4,25);
    HZ_16x16_Display(HZ_16x16+5,4);
  }
}
void YB_UI(void)
{
   LCD_Clear();
   HZ_12x12_Display((HZ_12x12+12),3 ,115);
   HZ_12x12_Display((HZ_12x12+13),3 ,103);
   HZ_12x12_Display((HZ_12x12+14),3 ,91);
   HZ_12x12_Display((HZ_12x12+15),3 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,3,73);   
 
  
   HZ_12x12_Display((HZ_12x12+16),1 ,115);
   HZ_12x12_Display((HZ_12x12+17),1 ,103);
   HZ_12x12_Display((HZ_12x12+2),1 ,91);
   HZ_12x12_Display((HZ_12x12+3),1 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,1,73);   
 
   
   HZ_12x12_Display((HZ_12x12+12),2 ,115);
   HZ_12x12_Display((HZ_12x12+13),2 ,103);
   HZ_12x12_Display((HZ_12x12+18),2 ,91);
   HZ_12x12_Display((HZ_12x12+19),2 ,79);
   ASCII_6x12_Display(ASCII_6x12+10,2,73);  
...
void YB_UI_Update()
{
  ...
  if(YB_LOCAL_MSG[1] == 0xfa)
  {
    switch(YB_LOCAL_MSG[3])
    {
      case 0:
        break;
      case 1:
        HZ_12x12_Display((HZ_12x12+25),3 ,61);  
        HZ_12x12_Display((HZ_12x12+26),3 ,49); 
        break;
      case 2:
        HZ_12x12_Display((HZ_12x12+27),3 ,61);  
        HZ_12x12_Display((HZ_12x12+26),3 ,49); 
        break; 
      case 3:
        HZ_12x12_Display((HZ_12x12+26),3 ,61);  
        HZ_12x12_Display((HZ_12x12+28),3 ,49); 
        break;
      case 4:
        HZ_12x12_Display((HZ_12x12+29),3 ,61);  
        HZ_12x12_Display((HZ_12x12+30),3 ,49); 
        break;
      case 5:
        HZ_12x12_Display((HZ_12x12+31),3 ,61);  
        HZ_12x12_Display((HZ_12x12+32),3 ,49); 
        break;
      case 6:
        HZ_12x12_Display((HZ_12x12+33),3 ,61);  
        HZ_12x12_Display((HZ_12x12+34),3 ,49); 
        break;
      case 7:
        HZ_12x12_Display((HZ_12x12+35),3 ,61);  
        HZ_12x12_Display((HZ_12x12+36),3 ,49); 
        break;
      case 14:
        HZ_12x12_Display((HZ_12x12+37),3 ,61);  
        HZ_12x12_Display((HZ_12x12+38),3 ,49); 
        break;
     default:
        HZ_12x12_Display((HZ_12x12+39),3 ,61);  
        HZ_12x12_Display((HZ_12x12+40),3 ,49); 
         break;    
    }
  }
  ...
  if(YB_LOCAL_MSG[1] == 0xfa)
  {
    x = YB_LOCAL_MSG[4] * 60 + YB_LOCAL_MSG[5]; 
    if(0<x && x<=1859)
    {
      y = x / 1000;
      ASCII_6x12_Display(ASCII_6x12+y,1,67); 
      ...
      ASCII_6x12_Display(ASCII_6x12+y,1,61); 
      y = x / 10 % 10;
      ASCII_6x12_Display(ASCII_6x12+y,1,55); 
      y = x % 10;
      ASCII_6x12_Display(ASCII_6x12+y,1,49); 
    }
    
    HZ_12x12_Display((HZ_12x12+20),2 ,61);
    HZ_12x12_Display((HZ_12x12+21),2 ,49);
  }
