 ...
 * Public function defined in gapbondmgr.h.
 */
void GAPBondMgr_Register( gapBondCBs_t *pCB )//×¢²ágapBondCBs_t»Øµ÷º¯Êý
{
  pGapBondCB = pCB;
 ...
 * Public function defined in gapbondmgr.h.
 */
bStatus_t GAPBondMgr_PasscodeRsp( uint16 connectionHandle, uint8 status, uint32 passcode )//·¢ËÍÃÜÂëÇëÇó
{
